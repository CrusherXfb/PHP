<div class="list-group-item list-group-item-action mb-2 shadow-sm" style="border-left: 5px solid 
    ...
    <div class="d-flex w-100 justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            ...
            <?php endif; ?>
            <h5 class="mb-1 <?= isset($task['completed']) && $task['completed'] ? 'text-decoration-line-through' : '' ?>">
                <?= h($task['title']) ?>
            </h5>
        </div>
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-4 text-end">
            <div class="btn-group btn-group-sm">
                ...
                <a href="#" onclick="event.preventDefault(); document.getElementById('delete-form-list-<?= $task['id'] ?>').submit();" class="btn btn-outline-danger">Удалить</a>
            </div>
            <form id="delete-form-list-<?= $task['id'] ?>" action="tasks" method="POST" style="display: none;">
